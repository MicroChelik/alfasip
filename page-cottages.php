	...
	<div class="row">
		...
		<div class="col-lg-9 pr-0">
			<div class="main-content-container cottage-container">
						...
						<div class="test-card">
							...
							<form>
								...
								<div class="test-card__btn d-flex justify-content-center">
									<button class="greenBtn">К следующему вопросу <img src="img/icons/whiteBtnArrow.svg"></button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-12">
						<h2 class="mb-5">Преимущества СИП-панелей<br>нашего производства</h2>
						<p>
